"""
Backtest-only calendar-family strategies — emit Trade objects over historical data.

BACKTEST ONLY — never wire these classes into live execution. The live signal
path is earnings_edge/live_signals.py (driven by strategies/*.toml); these
classes iterate historical rows for evaluation. Shared types (Trade, DataBundle,
