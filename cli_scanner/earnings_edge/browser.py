...
class MarketChameleonBrowser:
    ...
    _MAX_RETRIES = 3
    _BREAKER_THRESHOLD = 3  # consecutive per-ticker failures before MC is disabled
    ...
    def get_win_rate(self, ticker: str) -> WinRateData:
        ...
        # Source-level circuit breaker: when marketchameleon.com is down or
        # blocking us (e.g. ERR_HTTP2_PROTOCOL_ERROR), every ticker burns
        # _MAX_RETRIES x ~20s for nothing. Trip after 3 consecutive failures
        # and serve defaults for the rest of the process.
