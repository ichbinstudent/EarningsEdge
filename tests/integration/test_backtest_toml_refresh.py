...
def test_toml_strategy_backtest_deterministic_metrics(tmp_db_path, monkeypatch):
    ...
    monkeypatch.setattr(strat_mod, "score_calendar_trade", lambda **kwargs: stub_score)
    monkeypatch.setattr(
        strat_mod.CalendarCallStrategy,
        "_load_model",
...
def _seed_calendar_position(group_id="g1", entry=1.85, opened="2026-07-24T14:00:00+00:00", exit_by=None):
    from sqlalchemy import text
...
def test_exit_engine_scheduled_exit_auto_closes_on_real_toml_rules(tmp_path):
    ...
    _seed_calendar_position(opened="2026-07-21T14:00:00+00:00", exit_by=date(2026, 7, 31))
