...
class FakeInnerScanner:
    ...
    def scan_earnings(self, workers: int = 8, use_finnhub: bool = True, **kwargs) -> ScanResult:
        self.scan_calls.append({"workers": workers, "use_finnhub": use_finnhub, **kwargs})
...
class TestScanService(unittest.TestCase):
    ...
    def test_empty_result_is_unsuccessful(self):
